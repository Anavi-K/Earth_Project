...
$climate.onclick = () =>{
    ...
    $climate.style.backgroundColor = "#F70F0F"
    ...
    document.getElementById("save").innnerHtml = "Do your bit! Save trees use renewable energy sources and prefer to travel green."
...
$consumption.onclick = () =>{
    ...
    $consumption.style.backgroundColor = "#FFF573"
    $resources.style.backgroundColor = "transparent"
    $people.style.backgroundColor = "transparent"
    document.getElementById("save").innnerHtml = "Do your bit! Shop only what you need,eat only what you need and always save the left overs."
...
$resources.onclick = () =>{
    ...
    $climate.style.backgroundColor = "transparent"
    $consumption.style.backgroundColor = "transparent"
    $resources.style.backgroundColor = "#FFD733"
    $people.style.backgroundColor = "transparent"
    document.getElementById("save").innnerHtml = "Do your bit! Avoid all things plastic. Believe in Reduce, Reuse and Recycle."
...
$people.onclick = () =>{
    ...
    $consumption.style.backgroundColor = "transparent"
    $resources.style.backgroundColor = "transparent"
    $people.style.backgroundColor = "#FFAC33"
    document.getElementById("save").innnerHtml = "Do your bit! Never waste food.Rather offer it to people or animals who are in need."
